...
title: "MoneyBall:Baseball-Reference.com: W(ins) regression:: Wins2"
author: "bdanalytics"
...
min.RMSE.new = 4.066459; All.X.lm;               Final.lm imp: RA 100.00; RS 28.07
min.RMSE.new = 4.063103; Interact.High.cor.Y.lm; Final.lm imp: RD 100.00; RD:RS 24.04
...
glb_split_newdata_condition <- "Year >= 2002" # or "is.na(<var>)"; 
...
glb_rsp_var <- glb_rsp_var_raw #"Playoffs.fctr"
...
glb_exclude_vars_as_features <- c("OOBP", "OSLG", "Playoffs",
                                  "RankPlayoffs", "RankPlayoffs.my.fctr",
                                  "RankSeason", "RankSeason.my.fctr",
                                  "Team.fctr") 
...
print(myplot_scatter(glb_allobs_df, "W", "Team", colorcol_name="Playoffs") + 
...
model_id <- "CSM.RD"; indep_vars_vctr <- c(NULL
   ,"RD"
#    ,"<feat1>*<feat2>"
#    ,"<feat1>:<feat2>"
                                           )
for (method in c("lm")) {
    ...
    csm_featsimp_df <- myget_feats_importance(glb_models_lst[[csm_mdl_id]]);         print(head(csm_featsimp_df))
}
