...
title: "MoneyBall-Champion: WorldSeries.fctr classification:: Champ2"
author: "bdanalytics"
...
glb_rsp_var_raw <- "WorldSeries.fctr"

# for classification, the response variable has to be a factor
glb_rsp_var <- "WorldSeries.fctr"
...
glb_derive_lst[["NumCompetitors"]] <- list(
    mapfn=function(Year) { return(table(glb_allobs_df$Year)[as.character(Year)]) }    
    , args=c("Year"))    
...
# tst <- "NumCompetitors"; args_lst <- NULL; for (arg in glb_derive_lst[[tst]]$args) args_lst[[arg]] <- glb_allobs_df[, arg]; print(head(args_lst[[arg]])); print(head(drv_vals <- do.call(glb_derive_lst[[tst]]$mapfn, args_lst))); 
...
glb_exclude_vars_as_features <- c("RankPlayoffs") 
...
glb_trnobs_df <- myimport_data(url=glb_trnng_url, comment="glb_trnobs_df", 
                                force_header=TRUE)
glb_trnobs_df$WorldSeries.fctr <- as.factor(as.numeric(glb_trnobs_df$RankPlayoffs == 1))
glb_trnobs_df <- glb_trnobs_df[!is.na(glb_trnobs_df$RankPlayoffs), ]
